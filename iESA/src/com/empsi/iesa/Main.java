...
public class Main extends SherlockFragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Tab tab3 = actionbar.newTab().setText("Bookmarks").setIcon(android.R.drawable.ic_input_get);
        ...
        tab3.setTabListener(new MyBookmarkListener<CFragment>(this, "tab3", CFragment.class));

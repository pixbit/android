...
//        one.setText("Tab A").setTag("A");
//        two.setText("Tab B").setTag("B");
//        three.setText("Tab C").setTag("C");
//        actionBar.addTab(one, 0, true);
//        actionBar.addTab(two, 1, false);
...
//        Toast.makeText(this, this.currentEntries.get(position).getView(), Toast.LENGTH_SHORT).show();
        ...
        switch(view){
        		case 1:
        			url = "file:///android_asset/cleanwateract.htm";
        			break;
        		case 2:
        			url = "file:///android_asset/descriptionnationwidepermits.htm";
        			break;
        		case 3:
        			url = "file:///android_asset/nationwidepermitgeneralconditions.htm";
        			break;
        		case 4:
